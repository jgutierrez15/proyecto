...
<html>
  ...
  <body>
   ...
   <?php include("nav_admin.php") ?>
    ...
    <h1>Control de Slider Principal</h1>
   <a href="new/sliderprincipal.php"> <button type="button" class="btn btn-outline-info">Nuevo Slider</button></a>

<table class="table table-bordered table-dark">
  <thead>
    <tr>
      <th scope="col">Nombre Slider</th>
    
      <th scope="col">Imagen de Slider</th>
  ...
  <?php foreach($slide as $img):?>
    <tr>
    <td ><?php echo $img->nom_sld_principal; ?></td>
     
      <td><img src="<?php echo $img->folder.$img->src ?>" alt="person" style="width:150px;" ></td>
      <td ><?php echo $img->created_at; ?></td>
      <td><a href="change/modSliderp.php?id_sld_principal=<?php echo $img->id_sld_principal; ?>">
      <button type="button" class="btn btn-outline-primary">Modificar</button></a> 
      <a  href="eliminar/action_drop_Sliderp.php?id_sld_principal=<?php echo $img->id_sld_principal; ?>"><button type="button" class="btn btn-outline-danger">Eliminar</button></a></td>
