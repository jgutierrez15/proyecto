...
<table class="table table-bordered table-dark">
  ...
  <?php foreach($encabezados as $img):?>
    <tr>
      <th scope="row"><?php echo $img->order_enc; ?></th>
      <td><?php echo $img->nom_enc; ?></td>
      <td><a href="change/modencabezado.php?cod_enc=<?php echo $img->cod_enc; ?>"><button type="button" class="btn btn-outline-primary">Modificar</button></a></td>
