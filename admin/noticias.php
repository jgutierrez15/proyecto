...
<html>
  ...
  <body>
   ...
   <a href="./new/noticia.php"> <button type="button" class="btn btn-outline-info">Nueva Noticia</button></a>
...
<table class="table table-bordered table-dark">
  ...
  <thead>
    ...
    <tr>
      ...
      <th scope="col">Imagen de Noticia</th>
  ...
  <?php foreach($noticias as $img):?>
    ...
    <td ><?php echo $img->nom_noticia; ?></td>
      ...
      <td><a href="change/modNoticias.php?cod_noticia=<?php echo $img->cod_noticia; ?>">

      <button type="button" class="btn btn-outline-primary">Modificar</button></a> 

      <a  href="eliminar/action_drop_noticia.php?cod_noticia=<?php echo $img->cod_noticia; ?>"><button type="button" class="btn btn-outline-danger">Eliminar</button></a></td>
