...
<form class="needs-validation form_modif" novalidate   enctype="multipart/form-data" method="post" action="action_addnoticia.php">
  ...
  <div class="form-group">
    ...
    <label for="exampleInputEmail1"> Nombre De Noticia</label>
      ...
      <input type="text"  class="form-control" id="exampleInputEmail1" id="validationCustom01" 
       pattern="^[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]{5,30}" name="nombre" id="nombre" placeholder="Ingresa Nombre de noticia" required>
  ...
  <div class="form-group">
    ...
    height: 300px;" name="contenido" max-length="20" onkeyup="countChars(this);"></textarea>
