...
<html>
  ...
  <body>
    ...
    <h1>CATEGORIAS </h1>
    <a href="./new/categoria.php"> <button type="button" class="btn btn-outline-info">Nueva Categoria</button></a>
...
<table class="table table-bordered table-dark">
  ...
  <?php foreach($categorias as $img):?>
    <tr>
      <th scope="row"><?php echo $img->id_categoria; ?></th>
      <td><?php echo $img->nombre; ?></td>
      <td><a href="change/modCategoria.php?id_categoria=<?php echo $img->id_categoria; ?>">

<button type="button" class="btn btn-outline-primary">Modificar</button></a> 

<a  href="eliminar/action_drop_categoria.php?id_categoria=<?php echo $img->id_categoria; ?>"><button type="button" class="btn btn-outline-danger">Eliminar</button></a></td>
