...

{
    ...
    <form class="needs-validation form_modif" novalidate   method="post" action="modefectivo.php">

<input type="hidden" value="<?php echo $row1["id"]?>" name="codigo" >

<div class="form-group">

    <label for="exampleInputEmail1">Codigo de Pedido</label>
...
<option value="<?php echo $row1["id_estado"]?>"> <?php echo  $row1["nombre_estado"] ?></option>

<?php foreach($estados as $img):?>

<option value="<?php echo $img->id_estado; ?>"><?php echo $img->nombre_estado; ?></option>
