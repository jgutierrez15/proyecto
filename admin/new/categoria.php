...
<form class="needs-validation form_modif" novalidate   method="post" action="action_addcategoria.php">
...
<input type="text"  class="form-control"  pattern="[a-zA-Z0-9]{5,20}" name="nombre" id="nombre" placeholder="Ingresa Nombre de Categoria" required>
