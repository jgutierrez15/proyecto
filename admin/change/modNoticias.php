...
$idpage = mysqli_real_escape_string($connect, $_GET['cod_noticia']);



$query2="select * from noticias where cod_noticia='$idpage'";
...

{
    ...
    <form class="needs-validation form_modif" novalidate   enctype="multipart/form-data" method="post" action="action_mNoticia.php">

<input type="hidden" value="<?php echo $row1["cod_noticia"]?>" name="codigo" >



<div class="form-group">

    <label for="exampleInputEmail1"> Nombre De Noticia</label>

      <input type="text"  class="form-control" id="exampleInputEmail1" id="validationCustom01"  pattern="^[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ\s]{5,30}" value="<?php echo $row1["nom_noticia"]?>" name="nombre" id="nombre"  required>

    

    <div class="invalid-feedback">

        El Nombre debe tener mas de 5 y menos de 30 caracteres alfanumericos.
  ...
  <div class="form-group">
    ...
    <label for="exampleInputEmail1">Contenido de Noticia</label>

    <textarea style="    width: 100%;
    height: 300px;" name="contenido" max-length="20" onkeyup="countChars(this);"><?php echo $row1["contenido_noticia"]?></textarea>
