...
$idpage = mysqli_real_escape_string($connect, $_GET['codigo_user']);
$query2="select * from users where codigo_user='$idpage'";
...

{
    ...
    <form class="needs-validation form_modif" novalidate   enctype="multipart/form-data" method="post" action="action_mUsuarios.php">
<input type="hidden" value="<?php echo $row1["codigo_user"]?>" name="codigo" >
<div class="form-group">
  <label for="exampleInputEmail1"> Usuario</label>
    <input type="text"  class="form-control" pattern="[a-zA-Z0-9]{5,20}" value="<?php echo $row1["user"]?>" name="user" id="user"  required>
...
<input type="password"  class="form-control" id="exampleInputEmail1" id="validationCustom01" pattern="^(?=\w*\d)(?=\w*[A-Z])(?=\w*[a-z])\S{8,16}$" value="<?php echo $row1["pass"]?>" name="contraseña" id="contraseña"  required>
  <div class="invalid-feedback">
...
<div class="form-group">
  <label for="exampleInputEmail1"> Nombre Completo</label>
    <input type="text"  class="form-control" id="exampleInputEmail1" id="validationCustom01" pattern="[a-zA-Z\s]{5,}" name="nombre" id="nombre" value="<?php echo $row1["nom_user"]?>" required> 
  <div class="invalid-feedback">
      El usuario debe tener mas de 5  letras.
    </div>
</div>
